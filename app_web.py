...
# Enfoque: Alta legibilidad, corrección de NameError e inyección CSS limpia
...
# 1. CONFIGURACIÓN VISUAL DEL FRAMEWORK (Siempre debe ir primero)
st.set_page_config(
        ...
        with st.spinner("Buscando en la base normativa institucional..."):
            ...
            try:
                ...
                try:
                    ...
                    # Calibración de tolerancia: Máximo 12 páginas para no desbordar tokens
