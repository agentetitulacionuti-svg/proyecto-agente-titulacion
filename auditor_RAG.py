...
# Enfoque: Poka-Yoke Estético / Enrutamiento Quirúrgico de Alta Disponibilidad
...
st.markdown(
    ...
    .stApp {
        background-image: url("https://www.indoamerica.edu.ec/wp-content/uploads/2025/06/Logo-indoamerica2-25-768x218.png");
